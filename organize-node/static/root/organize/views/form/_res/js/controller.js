var app = angular.module('form', [{
    files:[
        "root/organize/views/form/_res/js/service.js"
    ]
}]);
app.controller('formCtrl',function ($scope,$state) {

    if ($state.current.url == '/form') {//默认加载列表
        $state.go('root.organize.views.form.list[12]');
    }

}).controller('formMenuCtrl',function($scope,$state,$rootScope,$location){
